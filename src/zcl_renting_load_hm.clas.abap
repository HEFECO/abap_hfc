CLASS zcl_renting_load_hm DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_renting_load_hm IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
  DATA: lt_brands    TYPE TABLE OF zrenthm_brands,
          lt_cars      TYPE TABLE OF zrenthm_cars,
          lt_customers TYPE TABLE OF zrenthm_customer.
...
*    ( marca = 'BMW' url = 'https://www.bmw.com.mx/content/dam/bmw/common/all-models/3-series/sedan/2018/navigation/bmw-3-series-modellfinder.png' ) ).
    ...
    DELETE FROM zrenthm_brands.
    INSERT zrenthm_brands FROM TABLE @lt_brands.
    SELECT * FROM zrenthm_brands INTO TABLE @lt_brands.

    out->write( sy-dbcnt ).
    out->write( 'zrenthm_brands data inserted successfully!').

** CARS**
    lt_cars = VALUE #(
    ( matricula = '1246GSA' marca = 'BMW' modelo = 'SERIE 4' color = 'BLANCO' motor = '2.5' potencia = '210' und_potencia = 'CV'
        combustible = 'GASOLINA' consumo = '7.00' fecha_fab = '20240418' puertas = '5' precio = '210' moneda = 'USD' alquilado = 'X' alq_desde = '20251201' alq_hasta = '20251231' )
   ...
   fecha_fab = '20240617' puertas = '5' precio = '160'
   ...
   fecha_fab = '20240304' puertas = '3' precio = '140'
   moneda = 'USD' alquilado = 'X' alq_desde =
   ...
   fecha_fab = '20240924' puertas = '5' precio = '160'
   moneda = 'USD' alquilado = 'X' alq_desde =
   ...
   fecha_fab = '20240726' puertas = '5' precio = '160'
   moneda = 'USD' alquilado = 'X' alq_desde =
   ...
   fecha_fab = '20240614' puertas = '5' precio = '180'
   moneda = 'USD' alquilado = 'X' alq_desde =
   ...
   fecha_fab = '20250716' puertas = '5' precio = '180'
   moneda = 'USD' alquilado = 'X' alq_desde =
   '20251201' alq_hasta = '20251206' )
   ...
   fecha_fab = '20240812' puertas = '3' precio = '150'
   moneda = 'USD' alquilado = 'X' alq_desde =
   '20251106' alq_hasta = '20251206' )
   ).

    DELETE FROM zrenthm_cars.
    INSERT zrenthm_cars FROM TABLE @lt_cars.
    SELECT * FROM zrenthm_cars INTO TABLE @lt_cars.

    out->write( sy-dbcnt ).
    out->write( 'zrenthm_cars data inserted successfully!').
...
** CUSTOMERS**
    ...
    DELETE FROM zrenthm_customer.
    INSERT zrenthm_customer FROM TABLE @lt_customers.
    SELECT * FROM zrenthm_customer INTO TABLE @lt_customers.

    "Salida en consola
    out->write( sy-dbcnt ).
    out->write( 'zrenthm_customer data inserted successfully!').
